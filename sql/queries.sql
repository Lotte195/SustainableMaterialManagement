...
-- The other query that we used was "WHERE NOT EXISTS" to see if there exists suppliers that do NOT use any extraction method, and therefore have the highest environmental risk rating (5)
